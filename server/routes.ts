...
// WebSocket functionality has been removed to improve performance and reliability.
// All requests are now processed via direct HTTP API calls.

// Note: Previous WebSocket handlers (handleChatMessage, handleGrammarCheck, handleParaphrase, 
// handleHumanize, and handleAiCheck) have been replaced with HTTP endpoints.
// See API implementation in server/api/* files.