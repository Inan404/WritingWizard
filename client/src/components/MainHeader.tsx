      ...
      <div className="container mx-auto flex justify-between items-center">
        <div className="flex items-center space-x-2 overflow-hidden">
          ...
          <div className="flex space-x-1 overflow-x-auto py-2 no-scrollbar md:flex-nowrap">
            <div className="flex items-center space-x-2 px-3 py-1 bg-muted rounded-md whitespace-nowrap">
              <svg className="h-4 w-4 text-red-500 shrink-0" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <span className="text-sm truncate">Introduction to...</span>
            </div>
            
            <div className="md:hidden lg:flex items-center space-x-2 px-3 py-1 bg-muted rounded-md whitespace-nowrap">
              <svg className="h-4 w-4 text-red-500 shrink-0" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
