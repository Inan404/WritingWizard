/**
 * AICheckComponent.tsx
 * 
 * This component detects whether text was generated by an AI model.
 * It uses the ZeroGPT API to analyze text and determine the likelihood of AI generation.
 * 
 * Features:
 * - AI content detection with percentage score
 * - Visualization of AI likelihood through progress bar
 * - Animated transitions for results
 * - Fallback to Perplexity API if ZeroGPT API fails
 * 
 * The component integrates with both ZeroGPT and Perplexity AI
 * to provide reliable AI detection capabilities.
 */
